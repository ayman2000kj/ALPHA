...
class ArthologieScreen extends StatelessWidget {
  final AppThemeMode appThemeMode;
  final ValueChanged<AppThemeMode> onThemeChanged;
  const ArthologieScreen(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(appThemeMode == AppThemeMode.dark ? Icons.light_mode : Icons.dark_mode),
          ),
        ],
      ),
      body: Center(
        child: Text(
          'صفحة أرثولوجي (تخصيص المحتوى لاحقًا)',
          style: GoogleFonts.montserrat(
            fontSize: 18,
