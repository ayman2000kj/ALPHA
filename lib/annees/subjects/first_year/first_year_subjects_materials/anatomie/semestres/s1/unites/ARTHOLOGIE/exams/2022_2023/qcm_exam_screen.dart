...
class QcmExamArthologie2022_2023Screen extends StatefulWidget {
  final AppThemeMode appThemeMode;
  final ValueChanged<AppThemeMode> onThemeChanged;

  const QcmExamArthologie2022_2023Screen({
    super.key,
  ...
  @override
  State<QcmExamArthologie2022_2023Screen> createState() =>
      _QcmExamArthologie2022_2023ScreenState();
}

class _QcmExamArthologie2022_2023ScreenState
    extends State<QcmExamArthologie2022_2023Screen> {
  ...
  Future<void> _loadQuestions() async {
    try {
      ...
      // تحميل الأسئلة من ملف JSON الموحد لأرثولوجي
      final questions = await QcmJsonService.instance.loadArthologieQuestions();
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return UnifiedExamWidget(
      ...
      examTitle: 'Examen Arthologie 2022-2023',
