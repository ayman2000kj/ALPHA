...
class QcmExamOsteologie2022_2023Screen extends StatefulWidget {
  final AppThemeMode appThemeMode;
  final ValueChanged<AppThemeMode> onThemeChanged;

  const QcmExamOsteologie2022_2023Screen({
    super.key,
  ...
  @override
  State<QcmExamOsteologie2022_2023Screen> createState() =>
      _QcmExamOsteologie2022_2023ScreenState();
}

class _QcmExamOsteologie2022_2023ScreenState
    extends State<QcmExamOsteologie2022_2023Screen> {
  ...
  Future<void> _loadQuestions() async {
    try {
      ...
      // تحميل الأسئلة من ملف JSON الموحد لأوستيولوجي
      final questions = await QcmJsonService.instance.loadOsteologieQuestions();
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return UnifiedExamWidget(
      ...
      examTitle: 'Examen Ostéologie 2022-2023',
