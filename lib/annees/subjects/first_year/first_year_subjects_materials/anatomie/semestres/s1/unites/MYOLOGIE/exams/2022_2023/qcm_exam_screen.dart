...
class QcmExamMyologie2022_2023Screen extends StatefulWidget {
  final AppThemeMode appThemeMode;
  final ValueChanged<AppThemeMode> onThemeChanged;

  const QcmExamMyologie2022_2023Screen({
    super.key,
  ...
  @override
  State<QcmExamMyologie2022_2023Screen> createState() =>
      _QcmExamMyologie2022_2023ScreenState();
}

class _QcmExamMyologie2022_2023ScreenState
    extends State<QcmExamMyologie2022_2023Screen> {
  ...
  Future<void> _loadQuestions() async {
    try {
      ...
      // تحميل الأسئلة من ملف JSON الموحد لميولوجي
      final questions = await QcmJsonService.instance.loadMyologieQuestions();
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return UnifiedExamWidget(
      ...
      examTitle: 'Examen Myologie 2022-2023',
